...
class Home {
    ...
    init() {
        (0, _commonJs.navLinkActive)((0, _commonJs.navLinks));
        (0, _commonJs.showBtnAnimation)((0, _commonJs.btnCta));
        (0, _commonJs.tabletNav)();
    ...
    getEmailSubcriber() {
        ...
        emailForm.addEventListener("submit", async (e)=>{
            try {
                ...
                await (0, _firebaseJs.checkEmailSubcriber)(email);
                if (!(0, _commonJs.validateEmail)(email)) throw new Error("please enter a valid email");
                (0, _commonJs.changeSubmitText)(btnSubcriberText, "Submitting...");
                if (!navigator.onLine) throw new Error("please check your internet connection");
                await (0, _firestore.addDoc)((0, _firebaseJs.emailSubcriber), {
                    email: email
                });
                (0, _commonJs.toast).success("Thanks for subscribing!");
                (0, _commonJs.toast).hide();
                setTimeout(()=>{
                    (0, _commonJs.changeSubmitText)(btnSubcriberText, "Get Started");
                }, 6000);
                emailForm.reset();
            } catch (error) {
                (0, _commonJs.changeSubmitText)(btnSubcriberText, "Get Started");
    ...
    getLoanApplication() {
        ...
        numberFields.forEach((numberField)=>{
            numberField.addEventListener("keydown", (e)=>{
                if (!(e.key === "Backspace" || e.key === "Delete" || e.key === "ArrowLeft" || e.key === "ArrowRight" || e.key === "Tab" || e.key === "Enter") && !(e.key >= "0" && e.key <= "9")) e.preventDefault();
            });
        });
        // repayment
        ...
        loanForm.addEventListener("submit", async (e)=>{
            try {
                ...
                if (!loanType || !amountOfMoney || !accountNumber || !repayments) throw new Error("please fill all fields");
                (0, _commonJs.changeSubmitText)(btnLoan, "Applying...");
                if (!navigator.onLine) throw new Error("please check your internet connection");
                await (0, _firestore.addDoc)((0, _firebaseJs.loanApplication), {
                    loanType: loanType,
                    amountOfMoney: amountOfMoney,
                    accountNumber: accountNumber,
                    repayments: repayments
                });
                (0, _commonJs.toast).success("Congratulations! Your application was successful!");
                (0, _commonJs.toast).hide();
                setTimeout(()=>{
                    (0, _commonJs.changeSubmitText)(btnLoan, "Apply For Loans");
                }, 6000);
                loanForm.reset();
            } catch (error) {
                (0, _commonJs.changeSubmitText)(btnLoan, "Apply For Loans");
    ...
    getContactUs() {
        ...
        contactUsForm.addEventListener("submit", async (e)=>{
            ...
            try {
                e.preventDefault();
                if (!email || !fullname || !message) throw new Error("please fill in all fields");
                if (!(0, _commonJs.validateEmail)(email)) throw new Error("Enter a valid email");
                if (!navigator.onLine) throw new Error("please check your internet connection");
                (0, _commonJs.changeSubmitText)(btnContactUsText, "Submitting...");
                await (0, _firestore.addDoc)((0, _firebaseJs.contactUs), {
                    fullname: fullname,
                    email: email,
                    message: message
                });
                ...
                setTimeout(()=>{
                    (0, _commonJs.changeSubmitText)(btnContactUsText, "Submit");
                }, 6000);
                contactUsForm.reset();
            } catch (error) {
                (0, _commonJs.changeSubmitText)(btnContactUsText, "Submit");
...
},{"./common.js":"2ASYY","firebase/firestore":"8A4BC","./firebase.js":"5VmhM"}],"2ASYY":[function(require,module,exports) {
